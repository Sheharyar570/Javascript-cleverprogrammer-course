...
function randomColors() {
    ...
    for (let i=1; i < all_buttons.length; i++) {
        ...
        all_buttons[i].classList.remove(all_buttons[i].classList[1]);
        all_buttons[i].classList.add(copyAllButtons[randNum]);
    }
}
...
let blackjackGame = {
    ...
    'cards': ['2', '3', '4', '5', '6', '7', '10', '8', '9', 'J', 'Q', 'K', 'A'],    
...
document.querySelector("#blackjack-hit-button").addEventListener('click', blackjackkHit);

document.querySelector("#blackjack-stand-button").addEventListener('click', dealerLogic);

document.querySelector("#blackjack-deal-button").addEventListener('click', blackjackDeal);

function blackjackkHit() {
...
function showCard(card, activeUser) {
    if (activeUser['score'] <= 21) {
        ...
        cardImage.style = 'height: 110px; width: 85px';
...
function computeWinner() {
    ...
    if(YOU['score'] <= 21) {
        ...
        //condition: high score than dealer or when dealer busts but you're
